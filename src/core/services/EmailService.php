...
class EmailService {
	...
	public function sendMessage ($to, $subject, $content, $headers = null) {
		$message_headers = "MIME-Version: 1.0" . "\r\n";
		$message_headers .= "Content-type:text/html;charset=UTF-8" . "\r\n";
		$message_headers .= "From: noreply@your-web-domain.com" . "\r\n"; // TODO: EMAIL SENDER
	...
	public function sendStyledMessage ($to, $subject, $content, $headers = null, $context = null) {
		$message_headers = "MIME-Version: 1.0" . "\r\n";
		$message_headers .= "Content-type:text/html;charset=UTF-8" . "\r\n";
		$message_headers .= "From: noreply@your-web-domain.com" . "\r\n"; // TODO: EMAIL SENDER
		$headers && $message_headers .= $headers;
